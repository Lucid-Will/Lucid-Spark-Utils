...
#             }
#         ]
#         utils.load_semantic_model_config('control_table', semantic_model_config)
#         ```
# 
...
#     - **Example:**
#         ```python
#         token = utils.get_service_principal_pbi_scope_token(
...
#     - **Example:**
#         ```python
#         utils.trigger_semantic_model_refresh("my-workspace-id", "my-dataset-id", "my-refresh-token")
#         ```
# 
...
#     - **Example:**
#         ```python
#         df_refresh_status = utils.get_semantic_model_refresh_status("my-workspace-id", "my-dataset-id", "my-refresh-token")
#         ```
# 
...
#     - **Example:**
#         ```python
#         utils.log_semantic_model_refresh_activity("log_table", df_refresh_state, "catalog", "log_table_storage_container_endpoint")
#         ```
# 
