...
class LucidUtils:
    ...
    def get_secret_value_as_managed_identity(self, key_vault_name: str, secret_name: str, managed_identity_name: str) -> str:
        """"
        Retrieves a secret value from Azure Key Vault.
    ...
    def read_delta_table(self, table_name: str, storage_container_endpoint: Optional[str] = None, read_method: str = 'path') -> DataFrame:
        ...
        return self.file_manager.read_delta_table(storage_container_endpoint, table_name, read_method)
    ...
    def read_delta_tables_concurrently(self, table_names: List[str], storage_container_endpoint: Optional[str] = None, read_method: str = 'default') -> Dict[str, DataFrame]:
        ...
        return self.file_manager.read_delta_tables_concurrently(table_names, storage_container_endpoint, read_method)
    ...
    def stage_dataframe_with_keys(self, target_table_storage_container_endpoint: str, target_table: str, dataframe: DataFrame, primary_key_column: Optional[str] = None, composite_key_column: Optional[str] = None, match_key_columns: Optional[List[str]] = None) -> Optional[DataFrame]:
        ...
        return self.dataframe_transformation_manager.stage_dataframe_with_keys(target_table_storage_container_endpoint, target_table, dataframe, primary_key_column, composite_key_column, match_key_columns)
    ...
    def upsert_data_concurrently(self, table_configs: List[Dict], storage_container_endpoint: Optional[str] = None, write_method: str = 'path') -> None:
        """
    ...
    def log_table_validation(self, target_storage_container_endpoint: str, target_table_name: str, log_storage_container_endpoint: str, log_table_name: str, primary_key_column: Optional[str] = None, stage_count: Optional[int] = None, invalid_count: Optional[int] = None, duplicate_count: Optional[int] = None, delete_count: Optional[int] = None) -> None:
        ...
        Example:
        log_table_validation("storage_container_endpoint", "my_table", "log_storage_container_endpoint", "log_table", "id", 100, 10, 5, 2)
        """
        self.logger.info(f"Logging table validation")
        return self.validation.log_table_validation(target_storage_container_endpoint, target_table_name, log_storage_container_endpoint, log_table_name, primary_key_column, stage_count, invalid_count, duplicate_count, delete_count)
    ...
    def data_validation_check(self, df_stage: DataFrame, storage_container_endpoint: str, target_table: str, composite_columns: List[str], primary_key_column: Optional[str] = None, dropped_validation_columns: Optional[List[str]] = None) -> None:
        ...
        return self.validation.data_validation_check(df_stage, storage_container_endpoint, target_table, composite_columns, primary_key_column, dropped_validation_columns)
    ...
    def hard_delete_records(self, target_table_storage_container_endpoint: str, target_table_name: str, primary_key_column, df_delete=None):
        ...
        return self.validation.hard_delete_records(target_table_storage_container_endpoint, target_table_name, primary_key_column, df_delete)
    ...
    def soft_delete_records(self, target_table_storage_container_endpoint: str, target_table_name: str, primary_key_column, df_delete=None):
        ...
        return self.validation.soft_delete_records(target_table_storage_container_endpoint, target_table_name, primary_key_column, df_delete)
    ...
    def build_dag(self, process_group: int) -> dict:
        ...
        Example:
        process_group = 1
        dag = OrchestrationManager.build_dag(process_group)
        """
    ...
    def log_orchestration_execution(self, execution_log: dict) -> None:
        ...
        return self.orchestration_manager.log_orchestration_execution(execution_log)
    ...
    def get_service_principal_pbi_scope_token(self, tenant_id: str, key_vault_name: str, client_id: str, client_secret: str, managed_identity: str) -> str:
        ...
        :param managed_identity: The name of the managed identity to use for secret retrieval.
