...
class UtilityManager:
    ...
    def flatten_properties(azure_object, logger=None):
        ...
        :raises AttributeError: If there's a problem accessing the attributes of the Azure object.

        This function performs the following steps:
        1. Initializes an empty dictionary to store the flattened object.
        2. Iterates over all attributes of the azure_object.
        3. Ignores private attributes and methods.
        4. Adds hashable values to the dictionary.
        5. Logs and raises any attribute errors that occur during the flattening process.

        Example:
            azure_object = AzureBlobStorageObject(...)
            logger = logging.getLogger(__name__)
            flat_object = flatten_properties(azure_object, logger)
        """
